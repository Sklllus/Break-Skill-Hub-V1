...
function BreakSkill:CreateWindow(options)
    ...
    function Tabs:CreateTab(options)
        ...
        Elements.Logo = Elements.SetLogo
        ...
        function Elements:AddToggle(options)
            ...
            local Check = Instance.new("ImageLabel", Color)
            local ColorCorner = Instance.new("UICorner", Color)
            local TitleToggle = Instance.new("TextLabel", Toggle)
            local UICorner_6 = Instance.new("UICorner", Toggle)
            ...
            ColorCorner.Name = "Color Corner"

            TitleToggle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            TitleToggle.BackgroundTransparency = 1
            TitleToggle.Position = UDim2.new(0.0692883879, 0, 0, 0)
            TitleToggle.Size = UDim2.new(0, 212, 0, 32)
            ...
            Toggle.MouseButton1Click:Connect(function()
                ...
                if Mouse_Entered then
                    TweenService:Create(Toggle, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundTransparency = 0.6}):Play()
        ...
        Elements.NewToggle = Elements.AddToggle
...
BreakSkill.NewWindow = BreakSkill.CreateWindow
